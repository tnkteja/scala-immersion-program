...
class LinesConsumerAndProducer(implicit mat: Materializer) extends Actor with ActorLogging {

  import LinesConsumerAndProducerCompanion._
...
object LinesConsumerAndProducerCompanion {
  case object Start
}